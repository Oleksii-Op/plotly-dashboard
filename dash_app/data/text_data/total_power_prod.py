...
total_body = [html.H3('Conclusion',
                      className='total-title'),
              html.Hr(),
              html.P("""In comparison to electricity production from renewable and fossil 
              ...
              html.Hr(),
              html.P("""In 2023, it decreased to 43.2%. Looking at the pie chart of fossil
              ...
              html.Hr(),
              html.H5("""Overall, the percentage of Fossil oil shale noticeably decreased.
